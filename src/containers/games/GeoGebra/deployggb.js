...
var GGBApplet = function () {
  ...
  applet.inject = function () {
    ...
    function continueInject() {
      ...
      if (type === 'screenshot') {
        ...
        if (
          (parameters.hasOwnProperty('playButton') && parameters.playButton) ||
  ...
  var fetchParametersFromApi = function (successCallback, materialsApiUrl) {
    ...
    var onError = function () {
      ...
      log(
        'Error: Fetching material (id ' + parameters.material_id + ') failed.'
      );
    };
...
GGBAppletUtils.makeModule = function (name, permutation) {
  function webModule() {
    ...
    webModule.__moduleBase =
      'https://www.geogebra.org/apps/5.0.593.0/' + name + '/';
...
if (typeof window.web3d !== 'function') {
  web3d = GGBAppletUtils.makeModule(
    'web3d',
    '13A189CD807DC2F933F34C9D9D9B6172'
  );
}
if (typeof window.webSimple !== 'function') {
  webSimple = GGBAppletUtils.makeModule(
    'webSimple',
    '108861FED24EFBF41AACC78877E7914D'
  );
}
